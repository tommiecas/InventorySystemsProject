 ...
 */
UCLASS()
class INVENTORYSYSTEMSPROJECTPLUGIN_API UINV_ItemPopUpWidget : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	void SetSplitAmount(const int32 Amount);
	void SetSizeBoxSize(const FVector2D& Size);
